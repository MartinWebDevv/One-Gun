...
static func snapshot() -> Dictionary:
	return {
		...
		"level_road": [
			...
			{"threshold": 10, "display_name": "Rice Hat", "gun_tokens": 0,
				"item_id": "beta_s1_level_30_hat", "rarity": "uncommon", "claimed": true},
		...
		"trophy_road": [
			...
			{"threshold": 5, "display_name": "Pimp Hat", "gun_tokens": 0,
				"item_id": "beta_s1_ace_hat", "rarity": "epic", "claimed": true},
