...
# -- Round rules --
const REACH_POWERUP_DISTANCE := 7.0
const SHARED_THROW_FORWARD_SPEED := 15.0
const SHARED_THROW_UPWARD_SPEED := 5.0
const SHARED_THROW_RELEASE_FORWARD_OFFSET := 0.6
const SHARED_THROW_RELEASE_HEIGHT := 1.0
...
const ONE_OF_US_THEM_SPEED_MULTIPLIER := 1.15
const DEFAULT_MELEE_HITBOX_LENGTH := 5.2
const ONE_OF_US_MELEE_HITBOX_LENGTH := DEFAULT_MELEE_HITBOX_LENGTH
