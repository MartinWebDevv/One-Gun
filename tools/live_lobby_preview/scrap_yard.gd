...
const Space=preload("res://tools/live_lobby_preview/scrap_space.gd")
const Actor=preload("res://tools/live_lobby_preview/scrap_actor.gd")
...
var update_left:=0.0
const Coin=preload("res://tools/live_lobby_preview/scrap_coin.gd")
