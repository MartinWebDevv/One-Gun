...
Local map loading offers Cancel/Escape before scene handoff. Online loading retains existing peer readiness/retry/return controls while resources load asynchronously. Unlisted lobby wording reflects discovery-only privacy; Friends Only admission has not been added. Hideout is not a live destination.
