...
const SMOKE_MASK_IMAGE: Image = preload("res://textures/smoke_mask.res")
...
func _build_smoke_texture() -> Texture2D:
	# Exact original mask/mipmaps, generated offline by tools/generate_smoke_mask.gd.
	# Avoid tens of thousands of GDScript pixel/trigonometry calls on first throw.
	return ImageTexture.create_from_image(SMOKE_MASK_IMAGE)
